...
export const PricingCard = ({
  ...
  type,
  className,
  checkCheck = "/assets/checkmark-9.svg",
  text = "Up to 5 project members",
  checkImg = "/assets/checkmark-9.svg",
  text1 = "Unlimited tasks and projects",
  checkCheck1 = "/assets/checkmark-9.svg",
  text2 = "2GB storage",
  checkCheck2 = "/assets/checkmark-9.svg",
  text3 = "Integrations",
  checkCheck3 = "/assets/checkmark-9.svg",
  text4 = "Basic support",
              ...
              <>
                {showBadge && (
                  <Badge
                    ...
                    inputIconsPropertyZapSize="/assets/input-icons-7.svg"
                    label="Most Popular"
                    state="default"
                  />
                )}
